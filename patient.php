  ...
  <!-- Fixed navbar -->
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        ...
        <p id="nrplevel">Look up patient outcomes by entering their unique 4-digit ID below</p>

        <!-- form prompting users for patient id -->
        <form action="lookup.php" method="post">
          <div class="col-md-4 col-md-offset-4">
            <input class="form-control" name="number" placeholder="Patient ID" type="text"/>
          </div>
          <br><br>
          <div class="col-md-4 col-md-offset-4">
